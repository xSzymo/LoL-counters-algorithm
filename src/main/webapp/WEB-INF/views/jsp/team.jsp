            ...
            <form method="get" action="counters">
                ...
                <div style="float: left">
                    <table>
                        ...
                        <tr>
                            <td><input type="radio" name="line" value="Mid"/>mid</td>
                        </tr>
                        <tr>
                            <td><input
                                    type="radio" name="line" value="Supp"/>supp
                            </td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="line" value="Adc"/>adc</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="line" value="Jungle"/>jungle</td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="line" value="Top"/>top</td>
                        </tr>
                        <tr>
                            <td><br> <input type="submit" name="name"
                                            id="Go" value="Go"></input></td>
                        </tr>
